      ...
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center border-b pb-2">
            ...
            <span className="text-gray-600">ahtishamrajputchohan@gmail.com</span>
          </div>
          <div className="flex justify-between items-center border-b pb-2">
            <span className="text-gray-700 font-medium">Phone</span>
            <span className="text-gray-600">+92313-3857238</span>
          </div>
          <div className="flex justify-between items-center border-b pb-2">
            <span className="text-gray-700 font-medium">Favorite Cuisine</span>
            <span className="text-gray-600">Pakistani</span>
          </div>
          <div className="flex justify-between items-center border-b pb-2">
            <span className="text-gray-700 font-medium">Location</span>
            <span className="text-gray-600">Hyderabad PAKISTAN</span>
          </div>
        </div>
