    ...
    <div className='lg:flex lg:gap-[100px] lg:px-[100px] px-6 lg:pt-[101px] pt-[50px]' >
      <div className='lg:flex flex-col lg:gap-[100px]  gap-4 lg:w-[25.28px] lg:h-[492px] md:hidden sm:hidden hidden'> 
       ...
       <a href="#">< FaFacebookF className='text-white' /></a>
        ...
        <div className='w-[108px] border-[1px] lg:block hidden rotate-90 text-white'></div>
      </div>
      ...
      <div>
        <Image src={heroimg} alt='' className='"w-auto h-auto lg:w-[550px] lg:h-[430px] rounded-[20px] lg:rounded-[30px]'/>
      </div>
    </div>
  )
}
